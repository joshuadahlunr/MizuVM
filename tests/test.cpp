...
int main() {
	...
	const static opcode program[] = {
		...
		opcode{label}.set_immediate(label2immediate("main")),
			...
			// 133 = uint32_t(*)(uint32_t, int32_t, uint32_t, void*)
			opcode{ffi::push_type_u32},
			opcode{ffi::push_type_u32},
			opcode{ffi::push_type_i32},
			opcode{ffi::push_type_u32},
			...
			opcode{jump_relative_immediate, 224}.set_immediate_signed(1), // Label top of loop!
				...
				opcode{load_immediate, a(0)}.set_immediate_f32(.7),
				...
				// uniform_matrix4fv(t6, 1, GL_FALSE, view(t4));
				// opcode{add, a(0), t(6)},
				opcode{load_immediate, a(1)}.set_immediate(1),
				opcode{load_immediate, a(2)}.set_immediate(GL_FALSE),
				opcode{add, a(4), t(4)},
				opcode{ffi::call_with_return, 0, 233, 133},

				// // t6 = glGetUniformLocation(t(1), "projection");
				// opcode{add, a(0), t(1)},
				...
				// opcode{ffi::call_with_return, t(6), 232, 132},
